...
HD_PWD='/net/e/ifischersch/EN325-Advanced-digital-design/2_PART_VHDL/4_DIV_SIGNED/4_DIV_SIGNED/4_DIV_SIGNED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DIVS_WRAPPER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DIVS_WRAPPER.tcl -notrace
