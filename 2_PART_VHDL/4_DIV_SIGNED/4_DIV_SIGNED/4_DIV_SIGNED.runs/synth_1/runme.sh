...
HD_PWD='/net/e/ifischersch/EN325-Advanced-digital-design/2_PART_VHDL/4_DIV_SIGNED/4_DIV_SIGNED/4_DIV_SIGNED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DIVS_WRAPPER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DIVS_WRAPPER.tcl
