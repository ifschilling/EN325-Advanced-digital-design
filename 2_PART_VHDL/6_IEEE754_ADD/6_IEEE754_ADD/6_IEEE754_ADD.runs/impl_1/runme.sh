...
HD_PWD='/net/e/ifischersch/EN325-Advanced-digital-design/2_PART_VHDL/6_IEEE754_ADD/6_IEEE754_ADD/6_IEEE754_ADD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ADDIEEE_WRAPPER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ADDIEEE_WRAPPER.tcl -notrace
