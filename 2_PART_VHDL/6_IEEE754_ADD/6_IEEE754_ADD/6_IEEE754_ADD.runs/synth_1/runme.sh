...
HD_PWD='/net/e/ifischersch/EN325-Advanced-digital-design/2_PART_VHDL/6_IEEE754_ADD/6_IEEE754_ADD/6_IEEE754_ADD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADDIEEE_WRAPPER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADDIEEE_WRAPPER.tcl
