...
HD_PWD='/net/e/ifischersch/EN325-Advanced-digital-design/2_PART_VHDL/3_MUL_CSTE/3_MUL_CSTE/3_MUL_CSTE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MULC_WRAPPER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MULC_WRAPPER.tcl
