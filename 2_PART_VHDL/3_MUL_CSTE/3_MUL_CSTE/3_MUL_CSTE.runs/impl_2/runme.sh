...
HD_PWD='/net/e/ifischersch/EN325-Advanced-digital-design/2_PART_VHDL/3_MUL_CSTE/3_MUL_CSTE/3_MUL_CSTE.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log MULC_WRAPPER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MULC_WRAPPER.tcl -notrace
